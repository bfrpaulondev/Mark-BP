...
- [ ] **ANT-256 — Consolidar browser real verificável.** PR #29 cobre janelas/tabs reais por UIA/Win32; PR #30 cobre efeitos DOM Playwright com postconditions; PR #31 acrescenta verificação SPA por MutationObserver com baseline de ruído, popups correlacionados por `expect_popup` e downloads correlacionados por `expect_download`, com persistência opt-in segura em Downloads. Falta apenas CDP opcional para browsers já iniciados explicitamente com remote debugging e E2E real antes de fechar a tarefa.
