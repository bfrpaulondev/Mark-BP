...
- [ ] **ANT-256 — Consolidar browser real verificável.** PR #29 adiciona inventário/foco de múltiplas janelas reais e tabs verificáveis por índice/título/URL, com UIA/Win32 e ambiguity fail-closed. Continuam pendentes CDP opcional para browsers já iniciados com remote debugging, popups/downloads e verificação SPA antes de marcar a tarefa completa.
